...
int main(){
   ...
   std::vector<std::pair<std::string, int>> mapper_output1 = {
        {"I", 1}, {"try", 1}, {"To", 1}, {"understand", 1},  {"What", 1},{"the", 1}, {"difference", 1},  {"Between", 1},  {"Me", 1},  {"And", 1},  {"You", 1}
    };
    std::vector<std::pair<std::string, int>> mapper_output2 = {
        {"Ok", 1}, {"Answer", 1}, {"Is", 1}, {"that", 1},  {"you", 1},{"A", 1}, {"bullshit", 1},  {"boy", 1}
    };
    std::mutex mx;
    ...
    std::cout<<shuffler_result.size()<<std::endl;
    std::cout<<shuffler_result[0].size()<<std::endl;
    std::cout<<shuffler_result[1].size()<<std::endl;
    std::cout<<shuffler_result[2].size()<<std::endl;
    std::cout<<shuffler_result[3].size()<<std::endl;
